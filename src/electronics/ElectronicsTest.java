...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() {
        ...
        sendTextToElement(By.id("FirstName"), "James");
        sendTextToElement(By.id("LastName"), "Bond");
        sendTextToElement(By.id("Email"), "casinoroyaljamesbond25@gmail.com");
        sendTextToElement(By.id("Password"), "Bond025%");
        sendTextToElement(By.id("ConfirmPassword"), "Bond025%");
        ...
        sendTextToElement(By.id("BillingNewAddress_Email"), "casinoroyaljamesbond25@gmail.com");
